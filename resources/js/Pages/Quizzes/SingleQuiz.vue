...
<template>
    <Layout>
        <main>
            <div class="container">
                <h1 class="quiz-title text-uppercase">{{props?.slug}}</h1>
                <section class="question-section">
                    <div class="question">
                        <h2 class="question-num">Question 11</h2>
                        <p class="question-text">
                            Which lifecycle method is called after a component
                ...
                <section class="questions-nav-section">
                    <p class="question-context">
                        <a href="#"
                            ><span class="question-num">Question 11/20</span></a
                        >
                        <a href="#"
                            ><span class="question-help">Need Help?</span></a
                        >
                    </p>
                    <div class="d-flex">
